...
class Vol:
    ...
    def Iteration(self):
        ...
        if self.lastTime!=0:
            ...
            self.increment==timedelta.total_seconds()
        self.Instruments.setFPS(1/self.increment,self.iterID)
...
if __name__ == '__main__':
    ...
    nouvelAvion['ElmAero']['TrainAvant']={'Mass': 50, 'a': 1, 'b': 0.35, 'c': 0.3, 'x': 0.8, 'y': 0, 'z': -1.2, 'Profil': 'Train', 'Plan': 'XYZ'}
    nouvelAvion['ElmAero']['TrainGauche']={'Mass': 50, 'a': 1, 'b': 0.35, 'c': 0.3, 'x': 2.7, 'y': -1, 'z': -1.2, 'Profil': 'Train', 'Plan': 'XYZ'}
    nouvelAvion['ElmAero']['TrainDroite']={'Mass': 50, 'a': 1, 'b': 0.35, 'c': 0.3, 'x': 2.7, 'y': 1, 'z': -1.2, 'Profil': 'Train', 'Plan': 'XYZ'}
    nouvelAvion['ElmAero']['Helice']={'Mass': 20, 'h': 0.2, 'r': 1, 'x': -0.1, 'y': 0, 'z': 0.15}
    nouvelAvion['ElmAero']['Moteur']={'Mass': 250, 'h': 1.2, 'r': 0.6, 'x': 0.6, 'y': 0, 'z': -0.2, 'Profil': 'SecondStruct', 'Plan': 'XYZ'}
    nouvelAvion['ElmAero']['Cabine']={'Mass': 130, 'h': 2.8, 'r': 1, 'x': 2.6, 'y': 0, 'z': 0, 'Profil': 'PrimStruct', 'Plan': 'XYZ'}
    nouvelAvion['ElmAero']['Queue']={'Mass': 109.751776412945, 'h': 4.28, 'r': 0.4, 'x': 6.14, 'y': 0, 'z': 0.2, 'Profil': 'SecondStruct', 'Plan': 'XYZ'}
    nouvelAvion['ElmAero']['AileGaucheFlap']={'Mass': 22.4061696685606, 'a': 1.47272727272727, 'b': 2.5, 'c': 0.119290909090909, 'x': 2.5, 'y': 1.25, 'z': 1, 'Profil': 'NACA2412', 'Plan': 'XZ'}
    nouvelAvion['ElmAero']['AileGaucheAileron']={'Mass': 26.8874036022727, 'a': 1.47272727272727, 'b': 3, 'c': 0.119290909090909, 'x': 2.5, 'y': 4, 'z': 1, 'Profil': 'NACA2412', 'Plan': 'XZ'}
    nouvelAvion['ElmAero']['AileDroiteFlap']={'Mass': 22.4061696685606, 'a': 1.47272727272727, 'b': 2.5, 'c': 0.119290909090909, 'x': 2.5, 'y': -1.25, 'z': 1, 'Profil': 'NACA2412', 'Plan': 'XZ'}
    nouvelAvion['ElmAero']['AileDroiteAileron']={'Mass': 26.8874036022727, 'a': 1.47272727272727, 'b': 3, 'c': 0.119290909090909, 'x': 2.5, 'y': -4, 'z': 1, 'Profil': 'NACA2412', 'Plan': 'XZ'}
    nouvelAvion['ElmAero']['StabGauche']={'Mass': 7.23137696588584, 'a': 1, 'b': 1.75, 'c': 0.081, 'x': 7.78, 'y': 0.875, 'z': 0, 'Profil': 'NACA0012', 'Plan': 'XZ'}
    nouvelAvion['ElmAero']['StabDroite']={'Mass': 7.23137696588584, 'a': 1, 'b': 1.75, 'c': 0.081, 'x': 7.78, 'y': -0.875, 'z': 0, 'Profil': 'NACA0012', 'Plan': 'XZ'}
    nouvelAvion['ElmAero']['Gouverne']={'Mass': 6.19832311361643, 'a': 1, 'b': 0.081, 'c': 1.5, 'x': 7.78, 'y': 0, 'z': 0.75, 'Profil': 'NACA0012', 'Plan': 'XY'}


    nouvelAvion['ElmAero']['FuelGauche']={'Mass': 86, 'a': 1.47272727272727, 'b': 5.5, 'c': 0.119290909090909, 'x': 2.5, 'y': 2.75, 'z': 1}
    nouvelAvion['ElmAero']['FuelDroite']={'Mass': 86, 'a': 1.47272727272727, 'b': 5.5, 'c': 0.119290909090909, 'x': 2.5, 'y': -2.75, 'z': 1}
    ...
    ParamInit={}
    ParamInit['vitesse'] = [55.7097169177535,0.0,7.10583123950937]    # Repère Global
    ParamInit['vitRot']=[0,0,0]
    ParamInit['position']=[0.0,0.0,100.0]
    ParamInit['assiette']=8.0
    ...
    commandesVol['TrimProfondeur']=-1.31
