...
class Instruments(Ui_Form):
    ...
    def setHorizon(self, assiette, inclinaison):
        ...
        self.horizon_label.setText(QtCore.QCoreApplication.translate("Form", "Inclinaison: " + str(
            round(inclinaison, 1)) + " ° / Assiette: " + str(round(assiette, 1)) + " ° "))

    def valuechange(self):
        #inclinaison = self.horizontalSlider.value()
        profondeur = self.verticalSlider.value()/10
        commandesVol = {}
        commandesVol['Profondeur'] = profondeur
        commandesVol['Flap'] = 0
        ...
        self.Vol.Avion.ApplyCommandesVol(commandesVol)
    ...
    def showFlightParams(self, Vol):
        ...
        params += 'Profondeur ='+ str(round(Vol.Avion.Elements['StabGauche'].Gouverne, 3)) + '° \n'
